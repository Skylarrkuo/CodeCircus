...
START:
    ...
    INT 21H ;显示提示信息 1   
    MOV CL,0 ;密文字符个数
    MOV SI,1 ;_____________________________
Next:;循环输入明文
	MOV AH,1
	INT 21H
	CMP AL, 0dh
	JE Display ;______________________________
	CMP AL,'0' ;判断是否是数字字符
	JB Continue
	CMP AL,'9'
	JA Continue ;如果不是，则不加密
	AND AL, 00001111B ;______________________________
...
Continue:
	...
	INC CL
	INC SI
	JMP Next ;______________________________
Display	:
...
Again: ;循环显示密文
	...
	INT 21H
	INC SI
	LOOP Again ;______________________________
	MOV AH,2
	MOV DL,0ah
	INT 21H  ;显示换行
	MOV DL,0ah

...
;再利用0AH号功能再输入一个字符串，最后比较两个字符串是否相等(如果
...
Next: 
    ...
    INT 21H
	CMP AL, 0dh
	JE InputOver ;__________________
	MOV String1[SI], AL
	INC SI ;______________________
	JMP Next ;______________________
...
NextCMP:
	...
	INC SI;_______________________
	LOOP NextCMP
	MOV AH,9     
	LEA DX, DisplayYes
	INT 21H   ;显示'Yes'信息
	JMP CompOver ;______________________
NoEqual:
	MOV AH,9
	LEA DX, DisplayNo
	INT 21H ;显示'No'信息
